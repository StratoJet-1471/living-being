...
export default function EntityManager(props) {
    ...
    const movingDirectionTextColor = entityMovingDirection ? "black" : "#8B0000";
    ...
    return (
        <ThemeProvider theme={createTheme(DEFAULTS.mui_TabPanelTheme)}>
            <Box sx={DEFAULTS.mui_TabPanelSx}>
                <Box sx={{width: "300px", border: "1px solid black", p: "5px", backgroundColor: 'tabEntityManagerColor.main'}}>
                    <Typography variant="body1" color="tabEntityManagerColor.darker">
